...
do
    ...
    local ProggyTiny = Register_Font('ProggyTiny', 200, 'Normal', {
        Id = 'ProggyTiny.ttf',
        Font = game:HttpGet(
[[https://github.com/barbarianTopG/enigma/raw/main/tahoma_bold.ttf]]),
    })
    ...
    for _, instance in path:GetDescendants()do
        ...
        repeat
            ...
            elseif instance:IsA('Frame') then
                tween_service:Create(instance, TweenInfo.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
...
notifications.create_notification = function(self, options)
    ...
    tween_service:Create(outline, TweenInfo.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
...
library.dropdown = function(self, options)
    ...
    cfg.set = function(value)
        ...
        text.Text = (isTable and {
            (concat(selected, ', ')),
        } or {
            (selected[1]),
        })[1]
        flags[cfg.flag] = (isTable and {selected} or {
            (selected[1]),
        })[1]
...
library.keybind = function(self, options)
    ...
    keybind_holder.MouseButton1Down:Connect(function()
        ...
        text.Text = '...'
        cfg.binding = library:connection(uis.InputBegan, function(
            keycode,
            game_event
        )
